  ...
  return (
    <div
      className={`relative bg-background rounded-lg border transition-smooth hover:shadow-card ${
        isSelected ? 'border-primary ring-2 ring-primary-100' : 'border-border hover:border-primary-200'
      }`}
      ...
      <div className="relative h-32 rounded-t-lg overflow-hidden bg-surface">
        ...
        <div className="absolute top-2 left-2">
          <div className={`px-2 py-1 rounded-full text-xs font-medium ${
            tree.privacy === 'private' ?'bg-text-primary/80 text-white' :'bg-accent/80 text-white'
          }`}>
            <Icon 
        ...
        <div className="absolute top-2 right-2">
          <button
            ...
            className={`w-8 h-8 bg-background/80 backdrop-blur-sm rounded-full flex items-center justify-center transition-smooth hover:bg-background ${
          ...
          {/* Dropdown Menu */}
          {showMenu && (
            <div className="absolute right-0 mt-2 w-48 bg-background rounded-md shadow-modal border border-border z-10">
              <div className="py-1">
                <button
